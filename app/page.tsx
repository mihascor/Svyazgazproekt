    ...
    <div className="min-h-screen bg-white text-black overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 lg:pt-40">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#5fa8e8] via-transparent to-transparent"></div>
        </div>
      ...
      <section id="контакты" className="py-16 lg:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#5fa8e8] via-transparent to-transparent"></div>
        <div className="absolute inset-0"
             style={{
