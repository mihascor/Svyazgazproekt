      ...
      <header className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 bg-white/5 backdrop-blur-xl border border-[#0B1B2B]/30 rounded-full px-4 md:px-8 py-4 w-[calc(100%-3rem)] md:w-auto">
        <div className="flex items-center justify-between md:min-w-[900px]">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            ...
            <Link href="/documents" className="px-4 py-2 text-base text-[#0485c1] bg-white/10 rounded-full transition-all duration-300 cursor-pointer whitespace-nowrap">
              Документы
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 mt-2 bg-black/95 backdrop-blur-xl border border-white/20 rounded-2xl py-4 mx-4">
            <div className="flex flex-col space-y-2">
              <Link href="/" onClick={() => setMobileMenuOpen(false)} className="px-6 py-3 text-white/70 hover:text-[#0B1B2B]/70 hover:bg-white/10 transition-colors">
                Главная
              </Link>
              <Link href="/about" onClick={() => setMobileMenuOpen(false)} className="px-6 py-3 text-white/70 hover:text-[#0B1B2B]/70 hover:bg-white/10 transition-colors">
                О нас
              </Link>
              <Link href="/clients" onClick={() => setMobileMenuOpen(false)} className="px-6 py-3 text-white/70 hover:text-[#0B1B2B]/70 hover:bg-white/10 transition-colors">
                Заказчики
              </Link>
                ...
                <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-[#0B1B2B]/30 rounded-2xl p-6 md:p-8 hover:border-cyan-400/30 transition-all duration-300 h-full flex flex-col">
                  <div className="flex items-start justify-between mb-4 md:mb-6">
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-cyan-500 to-blue-500 bg-opacity-20 rounded-2xl flex items-center justify-center">
                      <i className={`${doc.icon} text-xl md:text-2xl text-[#0B1B2B]`}></i>
                    </div>
                  ...
                  <p className="text-sm md:text-base text-[#0B1B2B] mb-4 leading-relaxed">{doc.description}</p>
                  {doc.number && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
              <div>
                ...
                <div className="space-y-3 text-[#0B1B2B]/70">
                  ...
                  <div className="flex items-start space-x-3">
                    <i className="ri-hashtag text-[#0B1B2B] mt-1"></i>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <i className="ri-bank-line text-[#0B1B2B] mt-1"></i>
                    <div>
