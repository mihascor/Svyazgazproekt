...
export default function SecuritySystems() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#0B1B2B]/70">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 lg:pt-40 pb-8 lg:pb-12 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="absolute inset-0"
             style={{
               backgroundImage: `url('/security-systems_fon.webp')`,
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="mx-auto max-w-full lg:max-w-[1000px]">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black leading-none tracking-tight">
                <span className="block text-[#3b6a97]">ПРОЕКТИРОВАНИЕ КОМПЛЕКСОВ</span>
                <span className="block text-[#3b6a97]">ИНЖЕНЕРНО-ТЕХНИЧЕСКИХ</span>
                <span className="block text-[#3b6a97]">СРЕДСТВ ОХРАНЫ</span>
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="mb-16 md:mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-semibold text-[#0B1B2B]/70 mb-3 md:mb-4">
                  Анализ текущей оснащенности
                </h3>
                <p className="text-xs sm:text-sm md:text-base text-[#0B1B2B]/70 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 mb-8 md:mb-12 shadow-lg">
            <div className="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div className="flex-1">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#0B1B2B]/70 mb-4 md:mb-6">
                  Инженерно-технические средства защиты
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs sm:text-sm md:text-lg font-medium text-[#0B1B2B]/70">Инженерные заграждения</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs sm:text-sm md:text-lg font-medium text-[#0B1B2B]/70">Инженерные средства и сооружения</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs sm:text-sm md:text-lg font-medium text-[#0B1B2B]/70">Контрольно-пропускные пункты</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 mb-8 md:mb-12 shadow-lg">
            <div className="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div className="flex-1">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#0B1B2B]/70 mb-4 md:mb-6">Технические средства охраны</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Система охранной сигнализации зданий</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Система охранной сигнализации периметра объекта</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Система тревожной сигнализации</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Система контроля и управления доступом</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Система охранная телевизионная</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Система сбора и обработки информации</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70 leading-tight">Технические средства осмотра</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70">Система охранного освещения</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 bg-gray-50 rounded-xl p-3 md:p-4">
                    ...
                    <span className="text-xs md:text-sm font-medium text-[#0B1B2B]/70">Система электропитания</span>
                  </div>
                </div>
              </div>
            </div>
